...
export type AgentsBrainClawMemoryRecord = {
  id: string;
  content: string;
...
export type AgentsBrainClawMemoryListResult = {
  agentId: string;
  total: number;
  filtered: number;
  knowledge: number;
...
export type AgentsBrainClawMemoryUpdateResult = {
  ok: true;
  agentId: string;
  previousMemoryId: string;
  memory: AgentsBrainClawMemoryRecord;
};
