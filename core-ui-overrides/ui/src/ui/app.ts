...
export class OpenClawApp extends LitElement {
  ...
  @state() agentsPanel: "overview" | "memory" | "files" | "tools" | "skills" | "channels" | "cron" =
    "overview";
  @state() agentMemoryView: "file" | "brainclaw" = "file";
  ...
  @state() agentBrainClawMemoryError: string | null = null;
  @state() agentBrainClawMemoryList: import("./types.js").AgentsBrainClawMemoryListResult | null =
    null;
  @state() agentBrainClawMemorySelectedId: string | null = null;
  @state() agentBrainClawMemoryDraft = "";
  @state() agentBrainClawMemorySaving = false;
  @state() agentBrainClawMemoryQuery = "";
  @state() agentBrainClawMemoryClass = "all";
  @state() agentBrainClawMemoryLimit = 25;
  @state() agentBrainClawMemoryIncludeSuperseded = false;
