...
export const AgentsBrainClawMemoryRecordSchema = Type.Object(
  {
    id: NonEmptyString,
    content: Type.String(),
...
export const AgentsBrainClawMemoryListParamsSchema = Type.Object(
  {
    agentId: NonEmptyString,
    query: Type.Optional(Type.String()),
    area: Type.Optional(NonEmptyString),
...
export const AgentsBrainClawMemoryListResultSchema = Type.Object(
  {
    agentId: NonEmptyString,
    total: Type.Integer({ minimum: 0 }),
    filtered: Type.Integer({ minimum: 0 }),
    knowledge: Type.Integer({ minimum: 0 }),
    conversation: Type.Integer({ minimum: 0 }),
    page: Type.Integer({ minimum: 1 }),
    pageSize: Type.Integer({ minimum: 1 }),
    pageCount: Type.Integer({ minimum: 0 }),
    items: Type.Array(AgentsBrainClawMemoryRecordSchema),
  },
  { additionalProperties: false },
);

export const AgentsBrainClawMemoryUpdateParamsSchema = Type.Object(
  {
    agentId: NonEmptyString,
...
export const AgentsBrainClawMemoryUpdateResultSchema = Type.Object(
  {
    ok: Type.Literal(true),
    agentId: NonEmptyString,
    previousMemoryId: NonEmptyString,
    memory: AgentsBrainClawMemoryRecordSchema,
  },
  { additionalProperties: false },
);
