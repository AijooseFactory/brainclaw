...
behavior-changing work unless the specification documents why no practical
automated harness exists. When automation is not practical, include explicit
runtime verification tasks and written rationale.
...
**Purpose**: Project initialization, verification hooks, and basic structure

- [ ] T001 Create project structure per implementation plan
- [ ] T002 Initialize [language] project with [framework] dependencies
- [ ] T003 [P] Configure linting and formatting tools
- [ ] T004 [P] Establish runtime verification entry points and operator checks
...
- [ ] T010 Define migration and rollback tasks for incumbent behavior
...
### Tests for User Story 1 (required unless no practical harness exists) ⚠️
...
- [ ] T018 [US1] Add logging and runtime evidence for user story 1 operations
...
### Tests for User Story 2 (required unless no practical harness exists) ⚠️
...
### Tests for User Story 3 (required unless no practical harness exists) ⚠️
...
- [ ] TXXX [P] Additional unit and integration verification in tests/unit/ and
      tests/integration/
- [ ] TXXX Security hardening
- [ ] TXXX Migration and rollback validation
- [ ] TXXX Run quickstart.md validation and live runtime checks
...
- Tests MUST be written and FAIL before implementation unless the plan documents
  a no-harness exception with runtime verification instead
...
- Verify tests fail before implementing, or document why runtime probes are used
  instead
