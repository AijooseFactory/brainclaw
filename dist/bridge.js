...
import { sanitizeError } from "./sanitization.js";
 ...
 */
export async function callPythonBackend(module, funct, params, config = {}) {
    ...
    return new Promise((resolve, reject) => {
        ...
        if (!validateTenantUrl(config.postgresUrl)) {
            getLogger().security('bridge', 'validateConfig', `Tenant DB URL for postgres might be outside the allowed hosts list`, { url: config.postgresUrl ? '[REDACTED]' : 'undefined' });
        }
